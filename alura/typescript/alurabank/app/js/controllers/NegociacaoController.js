System.register(["../views/index", "../models/index", "../helpers/decorators/index", "../services/index", "../helpers/index"], function (exports_1, context_1) {
    ...
    var index_1, index_2, index_3, index_4, index_5, timer, NegociacaoController, Semana;
    return {
        setters: [
            function (index_1_1) {
                index_1 = index_1_1;
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            negociacoesParaImportar
                                .filter(negociacao => !negociacoesImportadas.some(importadas => negociacao.isEqual(importadas)))
